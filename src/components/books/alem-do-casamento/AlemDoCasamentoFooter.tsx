...
export default function AlemDoCasamentoFooter() {
  return (
    <footer className="relative py-12 lg:py-16 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl">
        <div
          ...
          style={{
            background: "linear-gradient(to right, transparent 0%, rgba(255, 140, 66, 0.2) 20%, rgba(255, 140, 66, 0.3) 50%, rgba(255, 140, 66, 0.2) 80%, transparent 100%)",
            maxWidth: "600px",
          }}
        />
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.03]">
        ...
        >
          <path
            d="M0,7 L40,3 L80,7 L120,3 L160,7 L200,3 L250,7"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
          ...
          <div className="flex flex-col items-center gap-6 lg:gap-8">
            ...
            <nav className="flex flex-wrap items-center justify-center gap-6 lg:gap-8">
              ...
              >
                ...
                <span
                  className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#FF8C42] to-[#FFA366] transition-all duration-300 group-hover:w-full"
                />
              </Link>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-foreground/40">
                Feito com <span style={{ color: "#FFA366" }}>♥</span> para leitores apaixonados
              </p>
            </div>
          </div>
        </div>
